            ...
            <Center borderWidth='1px'  margin="0" bgColor='white'>
                ...
                <HStack>
                   ...
                   <HStack fontWeight='500' spacing='20px'>
                      ...
                      <Link>Brands</Link>
                      <Link> Luxe</Link>
                      <Link>Naykaa Fashion</Link>
                      <Link>Beauty Advice</Link>
                   </HStack>
                </HStack>
                <HStack spacing={5}>
                    <HStack spacing={4}>
