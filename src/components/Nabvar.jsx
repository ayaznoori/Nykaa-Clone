import { Box, Center, HStack, Link, Stack ,Text,InputLeftElement,  Input,InputGroup} from '@chakra-ui/react'
...
const Nabvar = () => {
  ...
  return (
    <Box position={'fixed'} zIndex='99' width={'100%'}>
        <Stack spacing='0'>
            <Box  display='flex' padding='8px' justifyContent='space-around' backgroundImage='https://adn-static1.nykaa.com/media/wysiwyg/2021/common-strip.jpg'>
                   
                    <Box > <Text fontSize='lg' fontWeight='500' className={style.text} >BEAUTY BONANZA Get Your Daily Dose Of Amazing Deals</Text></Box>
                    <Box fontWeight='500'  fontSize='sm'> 
                       <HStack>
                        <HStack> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <title>mobile icon</title>
                            <g opacity=".92" fill="#000"><path d="M17.25 3.5v17H6.75v-17h10.5zm.5-1.5H6.25a1 1 0 00-1 1v18a1 1 0 001 1h11.5a1 1 0 001-1V3a1 1 0 00-1-1z"></path><path d="M13 6h-2a.75.75 0 110-1.5h2A.75.75 0 1113 6zM12 19.48a1 1 0 100-2 1 1 0 000 2z">
                            </path></g></svg> 
                           <Text> Get App |</Text>  </HStack> 
                        <HStack> 
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <title>address icon</title>
                        <g opacity=".92" fill="#000"><path d="M12 8a2.01 2.01 0 110 4 2.01 2.01 0 110-4zm0-1.5a4 4 0 00-.68.06 3.5 3.5 0 00.68 6.93 3.5 3.5 0 000-7v.01z"></path><path d="M12 3.5a6.94 6.94 0 012.22.37 6.53 6.53 0 014.28 6.47 6.6 6.6 0 01-1.78 4.49L12 20.24l-4.7-5.38a6.94 6.94 0 01-1.8-4.65A6.62 6.62 0 0112 3.5zM12 2a8.09 8.09 0 00-8 8.21 8.42 8.42 0 002.15 5.61l5.1 5.83a1.001 1.001 0 001.5 0l5.1-5.83A8.05 8.05 0 0020 10.36a8 8 0 00-5.31-7.91A8.34 8.34 0 0012 2z">
                        </path></g></svg> <Text>Store and Events |</Text> </HStack>  
                        <HStack><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <HStack spacing={5}>
                    ...
                    <InputLeftElement
                        ...
                        children={<SearchIcon color='gray.300' />}
                            />
                      <Input type='tel' placeholder='Search on Nykaa' variant='filled'/>
                     </InputGroup>
                    </HStack>
                    <HStack>
