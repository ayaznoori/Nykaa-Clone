import { Box, HStack, VStack,Text, Input, Button, Link, Center } from '@chakra-ui/react'
  ...
  return (
    <Box margin={0}  borderBottom='lightblue'>
         <VStack spacing={0}>
            ...
            <HStack justifyContent='center'   backgroundColor='rgb(140,141,148)' color='white' width='100%' padding={50} spacing={50} >
                <VStack align='left'>
